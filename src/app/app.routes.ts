...
export const routes: Routes = [
  ...
  { path: 'auth', loadChildren: () => import('./feature/auth/auth.module').then(m => m.AuthModule) },
  {
    ...
    children: [
      ...
      { path: 'facilities', loadChildren: () => import('./feature/facilities/facilities.module').then(m => m.FacilitiesModule) },
    ],
    canActivate:[authGuard]
  },
  { path: '**', loadComponent: () => import('./feature/shared/components/not-found/not-found.component').then(m => m.NotFoundComponent) },
];
